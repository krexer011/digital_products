    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists'}, help_text='Required. 30 characters or fewer, startinf with a letter, Letters, Digits', max_length=32, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z][a-zA_Z0-9_\\.]+S', 'Enter a valid username starting with a-z.This value may contain only letters, numbersand underscore characters.', 'invalid')], verbose_name='username')),
                ...
                ('phone_number', models.BigIntegerField(blank=True, error_messages={'unique': 'A user with this mobile number already exists'}, unique=True, validators=[django.core.validators.RegexValidator('^989[0-3,9]\\d{8}$', 'Enter a valid mobile number.')], verbose_name='mobile number')),
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether the user can log into this admin site', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='Designates this user should be treated as active.unselect this instead of deleting accounts', verbose_name='active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.NullBooleanField(help_text='femail is False, male is True, null is unset', verbose_name='gender')),
