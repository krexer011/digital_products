...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(_('username'), max_length=32, unique=True,
                                help_text=_('Required. 30 characters or fewer, startinf with a letter, Letters, Digits'),
    ...
    is_active = models.BooleanField(_('active'), default=True, 
                                help_text=_('Designates this user should be treated as active.'
...
class UserProfile(models.Model):
    ...
    gender = models.NullBooleanField(_('gender'), help_text=_('femail is False, male is True, null is unset'))
